FROM ubuntu
RUN apt update
RUN DEBIAN_FRONTEND=noninteractive apt install qemu-kvm *zenhei* xz-utils dbus-x11 curl gnome-system-monitor mate-system-monitor  git xfce4 xfce4-terminal tightvncserver wget   -y
